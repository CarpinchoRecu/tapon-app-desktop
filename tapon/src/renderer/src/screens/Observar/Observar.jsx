  ...
  return (
    <ProductosContext.Provider value={productoSeleccionado}>
      <div className="editar">
          ...
          <table className="tabla__datos__productos">
            <thead>
              <tr>
                ...
                <th>Fecha Ultimo Pago (Año/Mes/Dia)</th>
                <th>Fecha Proximo Pago (Año/Mes/Dia)</th>
              </tr>
            </thead>
            <tbody>
              {productosCliente.map((producto, index) => {
                const precioPorCuota = Math.floor(
                  producto.precio_producto / producto.cuotas_producto
                )
                ...
                const proximoPago = calcularUltimoPago(
                  producto.fecha_ultimo_pago,
                  producto.cada_cuanto_paga
                )
        ...
        <MenuProductos setProductoSeleccionado={setProductoSeleccionado} />
      </div>
